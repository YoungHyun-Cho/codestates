...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className='App'>
        {isLogin ? <Mypage accessToken={this.state.accessToken} issueAccessToken={this.issueAccessToken} /> : <Login loginHandler={this.loginHandler} issueAccessToken={this.issueAccessToken} />
        /* 
