...
*/
const PART4_3 = `INSERT INTO user (name, email) VALUES ('YoungHyunCho', '2020310133@khu.ac.kr')`; // 각 레코드를 문자열로 처리해줘야 함.
...
*/
const PART4_10 = `insert into content (title, body, userId) values ('Solo sprint', 'No contact from pair', 1)`;
