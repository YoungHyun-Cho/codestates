...
export function getFlight(filterBy = {}) {
  ...
  let url;
  if (dest === undefined) url = `http://ec2-13-124-90-231.ap-northeast-2.compute.amazonaws.com:81/flight?departure=${depart}`;
  else url = `http://ec2-13-124-90-231.ap-northeast-2.compute.amazonaws.com:81/flight?departure=${depart}&destination=${dest}`;
