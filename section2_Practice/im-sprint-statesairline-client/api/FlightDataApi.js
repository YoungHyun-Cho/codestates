...
export function getFlight(filterBy = {}) {
  ...
  let url = dest ?
    `http://ec2-13-124-90-231.ap-northeast-2.compute.amazonaws.com:81/flight?departure=${depart}&destination=${dest}`
    : `http://ec2-13-124-90-231.ap-northeast-2.compute.amazonaws.com:81/flight?departure=${depart}`;
